            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#features"><i class="bi bi-folder2-open"></i>Projets</a></li>
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download"><i class="bi bi-display"></i>Stage</a></li>
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download"><i class="bi bi-send"></i>Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
