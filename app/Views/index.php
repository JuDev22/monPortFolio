                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="portfolio-modal-title text-primary text-uppercase mb-2">Log Cabin</h2>
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-primary text-uppercase mb-0">Tasty Cake</h2>
                                    <!-- Portfolio Modal - Image-->
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-primary text-uppercase mb-0">Circus Tent</h2>
                                    <!-- Portfolio Modal - Image-->
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-primary text-uppercase mb-0">Controller</h2>
                                    <!-- Portfolio Modal - Image-->
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link me-lg-1" href="#contact"><i class="bi bi-send m-2"></i>Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <p>
                                👀 I'm interested in Desktop, Mobile and Web application development,<br>
                                🌱 I'm currently learning Full-Stack development and application programming,<br>
                                💞️ I’m not looking to collaborate on something during my formation.<br>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
